Public Class PlayingForm
    ...
    Public Class TeamData
        ...
        Public Sub New(Name1 As String, Name2 As String, Name3 As String, Name4 As String)
        ...
        Public Function nextTwoRolls(Frame() As Integer) As Integer
            ...
            If FrameIndex = (Scores.Length) Then
                If Frame(2) <> -1 Then
                    Points += Frame(2)
                    If Frame(3) <> -1 Then
                        Points += Frame(3)
    ...
    Public Class GameData
        ...
        Public Sub ResetFrames()
            Frames = 10
            'did you say it'd be easier to just make every game 12 frames?
            For Each Team In Teams
                If Team.TeamMembers.Length >= 3 Then
                    Frames = 12
                End If
            Next

            For Each Team In Teams
                Team.Scores = New Integer(Frames)() {}
                For Frame As Integer = 0 To Frames
    ...
    Private Sub PlayingForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If Team1Names(0) <> "" Then
            Dim Team1 As New TeamData(Team1Names(0), Team1Names(1), Team1Names(2), Team1Names(3))
        ...
        If Team2Names(0) <> "" Then
            Dim Team2 As New TeamData(Team2Names(0), Team2Names(1), Team2Names(2), Team2Names(3))
        ...
        If Team3Names(0) <> "" Then
            Dim Team3 As New TeamData(Team3Names(0), Team3Names(1), Team3Names(2), Team3Names(3))
        ...
        If Team4Names(0) <> "" Then
            Dim Team4 As New TeamData(Team4Names(0), Team4Names(1), Team4Names(2), Team4Names(3))
    ...
    Private Sub GameLoop() Handles MyBase.Activated
        ...
        For CurrentFrame As Integer = 0 To (Game.Frames - 1) 'stores which frame game is in, starting from 0. 
            For Each Team In Game.Teams
                Dim obje As Object = Me.Controls.Find("label1", True)
                ...
                PinsDowned = GetIntegerInput(String.Format("It's currently {0}'s turn! How many pins did they knock over? (Must be a number from 0 to 10.)", CurrentPlayer), String.Format("Input number of pins knocked over by {0} of Team {1} in Frame {2}", CurrentPlayer, (CurrentTeam + 1).ToString, (CurrentFrame + 1).ToString), 10)
